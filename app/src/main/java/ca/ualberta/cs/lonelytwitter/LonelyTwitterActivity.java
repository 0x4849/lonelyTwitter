    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NormalTweet myTweet = new NormalTweet(mbodyText);
                tweets.add(0, myTweet);
                myTweet.addThumbnail(thumbnail);
                adapter.notifyDataSetChanged();
                ElasticsearchTweetController.AddTweetTask newTask = new ElasticsearchTweetController.AddTweetTask();
                newTask.execute(myTweet);
